 ...
 * Se comprobrá si la esta es igual a la expresión de comparación. Si lo es 
...
class caseNode :
 ...
 public:
    ...
    * \param cases Nodo que representa el siguietne caso. 
    */
   caseNode (runNode* exp, runNode* cb, runNode* cases);
   /**
    * Método de ejecución del nodo. Evalua un nodo dado como parámetro
    * comparándolo con la expresión de comparación.  Si el resultado es
    * positivo se ejecuta el bloque de setencias y los bloques de los casos siguientes. Si el 
    * resultado es falso se ejecuta la evaluación del caso siguiete
    * \param eval Nodo que representa la expresión que será comparada
    * con la expresión del caso.
    */
   void run (runNode* eval);
   /**
    * Método de ejecución. Ejecuta el caso sin llevar a cabo la evaluación, lo que
    * conlleva la ejecución del bloque de sentencias y el caso siguiente.
    */
   void run ();
 private:
   runNode *exp_, *cb_;
 ...
 * 
 * Se compone de un nodo que representa una expresión evaluación y un nodo que representa
 * una lista de casos. El nodo evaluación será comparado con cada uno de los casos, si uno de 
 * estos da un resultado de comparación positivo se ejecuta su bloque de sentencias y todos los

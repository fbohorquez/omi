...
class whileNode :
 ...
 public:
   ...
   /**
    * Método que ejecuta el nodo. Ejecuta y evalua la condición y si esta
 ...
 * una condición y un bloque de sentencias. El bloque de sentencias 
 * será ejecutado mientras la evaluación de la condición sea verdadera, pero 
 * al menos una vez.
 * 
*/
class dowhileNode :
 ...
 public:
   ...
   /**
    * Método que ejecuta el nodo. Ejecuta el bloque de sentencias, luego ejecuta 
    * y evalua la condición. Si esta es positiva vuelve a repetir el proceso. 
    */   
   void run ();
 private:
   runNode *exp_, *rb_;
 ...
 * 
 * Este nodo representa una sentencia foreach. Permite ejecutar un bloque de sentencias para 
 * cada elemento contenido en un conjunto de elementos.
 *  
 * Se construye a partir un nodo que hace de conjunto a recorrer, un nodo que hace de identificador 
 * el cual referenciará al elemento actual en cada iteración y un nodo que hace de bloque de sentencias 
 * que se ejecutará para cada elemento. Es posible además especificar un 
 * nodo que hará de identificador en el que se guardará las claves de las referencias a los elementos
 * recorridos.
*/
class foreachNode :
   public runNode {
 public:
    /**
    * Constructor de la clase. 
    * \param val Nodo que hace de identificador para el valor de cada itereación.
   ...
   /**
    * Método de ejecución del nodo. Ejecuta el bloque de sentencias para cada elemento 
    * contenido en el conjunto, asignado el elemento al identificador del valor y la 
    * clave al identificador de clave si se facilitó. 
    */     
   void run ();
 private:
 ...
 *
 * La forma más simple de crear una lista por compresión es mediante una expresión de generación y una variable que iterará sobre una expresión conjunto. 
 * En cada iteración la variable iteradora tomará un valor del conjunto. Para cada elemento se calculará el valor de 
 * la expresión generadora, la cual normalmente contendrá la variable iteradora, y será introducido en 
 * un array resultado que será tomado como valor.
 * 
 * El conjunto sobre el que se itera dependerá del tipo de dato obtenido al evaluar la expresión conjunto:
 *    - Booleano: Se itera hasta que se evalua como falso. En cada iteración se asigna el entero correspondiente al número de la misma.   
 *    - Numérico: Si es positivo se itera desde cero hasta el valor sin incluirlo. Si es negtivo no se itera.
 ...
 * 
 * También se puede especificar una identificador que guarde la clave de la referecia del elemento iterado. 
 * 
 * El array resultado puede ser generado, además de mediante la expreesión de generación, mediante otra expresión que se corresponda 
 * con la clave del elemento creado. 
 * 
...
class foreachGeneratorNode :
 ...
 public:
   /**
    * Constructor de la clase
    * \param elem Nodo que representa el conjuento de elementos.
    * \param val Nodo que hace de identificador para el valor de cada itereación.
    ...
    * \param key Nodo que hace de identificador para la clave de cada itereación.
    * \param if_cond Nodo que hace de condición para que se lleve a cabo la insercción de los elementos de la itereación
    *  \param elem_key Nodo rpresenta la expresión generadora de la clave del elemento en la iteración
    */
 ...
 * 
 * Esta sentencia permite iterrar un conjunto de elementos de forma simple y rápida. 
 ...
 * mediante el uso del nodo \see getiNode . Esta estructura se organiza pòr niveles
 * cada uno de los cuales contendrá una pila de valores. Con cada sentencia iterativa ágil 
 * anidada se añadirá un elemento a la pila del nivel actual, y con cada llamada
 * a función se incrementará el nivel en uso.
 * 
 * El conjunto sobre el que se itera dependerá del tipo de dato obtenido al evaluar la expresión conjunto:
 *    - Booleano: Se itera hasta que se evalua como falso. En cada iteración se asigna el entero correspondiente al número de la misma.   
 *    - Numérico: Si es positivo se itera desde cero hasta el valor sin incluirlo. Si es negtivo no se itera.
 ...
 * generada en cada iteración. Además se podrá dar una expresión de incremento que será ejecutada 
 * en cada iteración. 
 */
class iloopNode :
   public runNode {
 public:
   /**
    * Constructor de la clase
    * \param iter Nodo que hace de conjunto de elemento a iterar.
    ...
    * \return Anterior valr en la cima
    */
 ...
 * 
 * Este nodo permite acceder a un elemento guadaro en la estructura de
...
class getiNode : public nexpNode {
 public:
    ...
    * \param node Nodo que representa el índice de para 
    *  acceso a la pila iloop. Si es NULL se accede al tope de la
    * pila.
    */
 ...
 * Para ello se precisa de un nodo que establece el número máxmimo de iteraciones, 
 * un identificador que referenciará el valor numérico de cada iteración, y el bloque de
 * sentencias
 */ 
class incloopNode :
   public runNode {
 ...
 * 
 * Este nodo se utiliza para finalizar la iteracion actual de un bloque de sentencias en una 
 * sentencia iterativa. Proseguiendo así con la evaluación de la siguiente iteración.  
 * 
 * Es posible especificar un valor que indica el número de sentencias iterativas que 
 * se saltarán.
 * 
...
class continueException :
 ...
 public:
   ...
   /**
    * Si el número de boloques anidados es mayor que uno lanza
 ...
 * 
 * Este nodo consta de una expresión de asignación, una condición, una expresión
 * de incremento y un bloque de sentencias.  Se ejecuta la expresión de asignación, 
 * luego mientras se cumpla la condición se ejecuta el bloque de sentencias y la
...
class forNode :public runNode {
 public:
    ...
    * a evaluar repitiendose el proceso desde este punto hasta que es
    * evaluada como falsa.
    */ 
   void run (); 
 private:

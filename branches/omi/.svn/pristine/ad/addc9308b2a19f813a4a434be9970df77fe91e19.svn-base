 ...
 *
 * Asigna el valor de un nodo a otro. La asignación se debe realizar sobre una
 * expresión de tipo no definido, modificándose la referencia interna de este 
 * al nodo asignado.
 *
 * Si el nodo que es asignado es constante será clonado y se asignará la copia.
 * Si el nodo es dinámico se asigna el propio nodo aumentaándose el
...
class asigNode :
 ...
 public:
    ...
    * Luego este valor es asignado a como referencia del lado izquierdo.
    * 
    ...
    * Se lleva a cabo la asignación, para ello se procesa el lado derecho de la asignación
    * en el nivel anterior de la tabla de símbolos. 
    * Luego este valor es asignado a como referencia del lado izquierdo en el nivel actual
   ...
   void runLevel ();
   /**
    * Asigna el valor de un nodo dado al referencia  del nodo del
   ...
   runNode* getRight ();
   /**
    * Las asignaciones deben ser ejecutadas cunado se encuentran dentro de 
    * una lista.
    */
 ...
 * \brief Nodo asignación
 *
 * Este nodo es utilizado en las listas de parámetros e indica que un parámetro debe ser
...
class asigrefNode :
 ...
 public:
    ...
    * una referencia al mismo como valor interno. Luego este valor es asignado
...
/**
 * \class getRefNode
 * \brief Nodo operador obtener referecia
 * 
 * Dado un nodo expresión de tipo no definido obtiene como valor la referencia 
 * interna del mismo.
 */
class getRefNode :
   public nexpNode {
 public:
   ...
   /**
    * Método que ejecuta el nodo. Obtiene la referencia
    * del nodo y la asigna como valor interno.
    */
   void run ();
 private:
   runNode *node_;
 ...
 *
 * Obtiene una referencia concreta dentro de la tabla de símbolos interna de un
 * nodo. Para ello se parte de una clave o índice. 
 * 
...
class getNode:
 ...
 public:
   /**
    * Constructor de la clase 
    * \param array Nodo que reresenta el elemento al que se accederá
    ...
    * dada por la clave en el elemento. Si la clave no existe se toma una referencia
    * a un nodo nulo. 
    */
   void run ();
   /**

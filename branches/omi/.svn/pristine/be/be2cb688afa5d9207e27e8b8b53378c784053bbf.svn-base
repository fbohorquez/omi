...
class boolconvNode :
 ...
 public:
   ...
   /**
    * Tras ser ejecutado el operador toma como valor el resultado de la conversión 
    * a booleano del nodo asociado
    */
   void run ();
   /**
 ...
 * cadena vacia en el caso falso 
 * Si el nodo es aritmético toma la cadena correspondiente al numero que 
 * representa
 * Si el nodo es array toma la cadena vacia
 */
class strconvNode :
   public stringNode {
 public:
   ...
   */  
   ...
   /**
   * Tras ser ejecutado el operador toma como valor el resultado de la conversión 
   * a cadena de caracteres del nodo asociado.
   */ 
   void run ();
 private:
   runNode *node_;

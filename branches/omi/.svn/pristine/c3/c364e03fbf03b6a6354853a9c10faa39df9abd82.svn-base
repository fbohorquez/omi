 ...
 *
 * El nodo raíz del ábol será ejecutado, lo que normalmente conllevará
 * la ejecución de sus nodos asociados, que a su vez ejecutarán los suyos propios,
 * y así sucesivamente. Esto produce un recorrido del árbol, donde los 
 * nodos son ejecutados. El recorrido tenderá a ser en profundidad, 
 * aunque estará muy condicionado por la propia ejecución de los nodos. 
 * 
 * Existen gran variadad de tipos de nodos de ejecución, cada uno de los cuales encierra
 * un significado semántico propio y se define a partir de unos datos concretos.  
 ...
 * semántico al ejecurse. Un árbol de ejecución conciste en una 
 ...
 * afines. Por ejemplo los nodos lógicos tendran un valor booleano
...
class runNode {
 public:
   ...
   */
   ...
   /**
    * Método que indica si el nodo puede ser representado mendiante 
...
class objectTypeNode: public printableNode {
 public:
   ...
   /**
    * Obtiene la clase a la que pertence el nodo. Este método 
    * deberá ser escrito por los nodos derivados
    * \retrun Nodo que representa la clase asociada al nodo
    */
   virtual runNode * getClass ();
   /**
    * Establece un nodo como clase del tipo de objeto
    * \param c Node que hace de clase
    */

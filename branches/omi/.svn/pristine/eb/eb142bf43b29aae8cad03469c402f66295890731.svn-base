 ...
 * 
 * Su ejecución conciste en el acceso a una la tabla de símbolos del contexto
...
class idNode :
 ...
 public:
    ...
    * \param id Nombre del dentificador
    */
   idNode (string id);
   /**
  ...
  /**
    ...
    * \param check_table Entorno de tablas de símbolos que 
    * se usará.
    */
...
class idgetNode: public idNode {
   public:
      ...
      */
       ...
       * Tras la ejecución del nodo devuelve si existía la referencia en la 
       * tabla de símbolos de funciones.
       * \return Booleano que indica si la funcion existe.
       */
      bool existf () const;
      /**
       * Tras la ejecución del nodo devuelve si existía la referencia en la 

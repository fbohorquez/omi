...
class sqrtNode :
 ...
 public:
   ...
   /**
    * Método que ejecuta el nodo. Procede a la ejecución del nodo asociados. 
 ...
 *
 * Este nodo implementa la operación asignación e decremento. Se toma el
 * valor de el nodo asociado, que normalmente representará un símbolo 

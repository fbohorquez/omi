 ...
 * que será utilizado en ramas posteriores. Para ello en la tabla de símbolos se crea un nodo 
 * referencia que apunta al valor creado. De esta forma, con solo conocer la clave de la referencia, 
 * es posible acceder al nodo creado en cualquier momento posterior de la ejecución.
 *
 ...
 * 
 * Los contextos puede tener ligados un nodo ejecutable. Este nodo, denominado nodo en uso o activo, 
 * es aquel que trabaja sobre los elementos de las tablas. Así un nodo clase, por ejemplo, el
 * contexto de una clase estará relacionado con la propia clase. Se crea así una referencia en doble sentido que permite,
 * conociendo un contexto, obtener el elemento que opera sobra ella.
 *
 * Se define el contexto principal como el primer  contexto que se crea en la ejecución.  Este es añadido 
 * a una lista de contextos. Cuando otro contexto fuera a ser usado es puesto 
 * al final de la lista hasta que finaliza su uso.
 *
...
class sTable {
 public:
   ...
   /**
    * Añade un referencia con la clave dada a la 
    * tabla de funciones. La referencia apuntará al nodo dado.
    * Si ya existía una referencia con dicha clave 
    * se elimina el valor anterior.
    * \param str Clave para la referencia
    * \param node Nodo al que apuntará la referencia.
   ...
   /**
    * Añade un referencia con la clave dada a la 
    * tabla de clases. La referencia apuntará al nodo dado.
    * Si ya existía una referencia con dicha clave 
    * se elimina el valor anterior.
    * \param str Clave para la referencia
    * \param node Nodo al que apuntará la referencia.
   ...
   /**
    * Obtiene la referencia de la tabla de funciones
    * correspondiente a la clave dada. Si la clave no se encuentra se
    * crea y devuelve una referencia que apunta a un nodo nulo.
    * \param str Clave relativa a la referencia
    * \return Referencia  dada por la clave.
   ...
   /**
    * Obtiene la referencia de la tabla de clases
    * correspondiente a la clave dada. Si la clave no se encuentra se
    * crea y devuelve una referencia que apunta a un nodo nulo.
    * \param str Clave relativa a la referencia
    * \return Referencia  dada por la clave.
   ...
   /**
    * Método modificador que cambia el nivel
   ...
   void setFunction (runNode *key, runNode* exp);
    /**
    * Obtiene el valor de la referencia dada por la clave facilitada en el nivel actual 
    ...
    * crea una nuevo contexto que será el inicial, y lo introduce en la lista de
    * en contextos en ejecución.
    *
   ...
   /**
    * Busca un contexto en la lista de contextos en
    * ejecución. Devuelve la posición en la que se encuentra
   ...
   /**
    * Referencia al nodo asociado al contexto. Representa
    * el nodo en uso
    *

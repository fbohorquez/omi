...
class numData {
   public:
      ...
      inline numData operator+(numData lhs){ return lhs.num_ + this->num_; }
      inline numData operator-(numData lhs){ return this->num_ - lhs.num_; }
      inline numData operator-(){ return -this->num_; }
      inline numData operator*(numData lhs){ return lhs.num_ * this->num_; }
      inline numData operator/(numData lhs){ return this->num_ / lhs.num_; }
      ...
      inline double getNum () const { return num_; }   
      inline double& getNum () { return num_; }   
   private:
      double num_;
};
//----------------------------------------------------------------------

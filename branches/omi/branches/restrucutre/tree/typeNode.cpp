...
//-------------------------------------------------------------------------------------------
//numCostNode
numCostnode::numConstNode (num data) : numNode (data) {}

void numCostNode::rmRef() {}

//-------------------------------------------------------------------------------------------

//-------------------------------------------------------------------------------------------
//listNode
listNode::listNode (runNode* ele1, runNode* ele2 = NULL):ele1_ (ele1), ele2_(ele2), exec_(false) {}
...
listNode* listNode::quitAsig () {
 ...
 bool listNode::lis_runlist () const {
   return true;
}
//----------------------------------------------------------------------
...
void arrayNode::insert (runNode* key, runNode* val, bool str = false) {
   if (str) {
...
void arrayNode::del (runNode* key, bool str = false, bool force_position = false ) {
   if (str) {
      key = new strNode (stringNode::to_str(key));
   }
...
runNode* arrayNode::get (runNode* key, bool str = false) {
   if (str) {
      key = new strNode (stringNode::to_str(key));
   }
   return
...
virtual runNode * arrayNode::copyArray (arrayNode * a) {
...
//-------------------------------------------------------------------------------------------
//objectNode
objectNode::objectNode (classNode * c = NULL) : class_ (c) { }

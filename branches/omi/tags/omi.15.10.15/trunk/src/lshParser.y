...
function  
   :  FUNCTION id '(' params_default ')' '{' stmts_level '}'  { 
 	...
 	|  DECORATOR id '(' params_default ')' '{' stmts_level '}'  { 
         runNode * r =new decoratorNode ($2, $4, $7);
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[3] = {$2, $4, $7};
            string b[3] = {"id", "params", "body"};
 	...
 	|  DECORATOR id '(' params_default ')' '{' '}'  { 
         runNode * r =new decoratorNode ($2, $4, NULL);
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[2] = {$2, $4};
            string b[2] = {"id", "params"};
 	...
 	|  DECORATOR id '('')' '{' stmts_level '}'  { 
         runNode * r =new decoratorNode ($2, NULL, $6);
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[2] = {$2, $6};
            string b[2] = {"id", "body"};
 	...
 	|	DECORATOR id '('')' '{' '}'  { 
         runNode * r =new decoratorNode ($2, NULL, NULL);
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[1] = {$2};
            string b[1] = {"id"};
...
function_lambda
   ...
   |	'~' '('')' '{' '}'  {  
	...
	|	'~' params_default ':' exp  { 
         runNode * r = new functionLambdaNode ($2, $4); 
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[2] = {$2, $4} ;
...
function_decorator
   :	DECORATOR '('')' '{' stmts_level '}'  {  
         runNode * r = new decoratorNode (NULL, NULL, $5); 
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[1] = {$5} ;
            string b[1] = {"body"};
   ...
   |	DECORATOR '(' params_default ')' '{' stmts_level '}'  {
         runNode * r = new decoratorNode (NULL, $3, $6); 
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[2] = {$3, $6} ;
            string b[2] = {"params", "body"};
   ...
   |	DECORATOR '(' params_default ')' '{' '}'  { 
         runNode * r = new decoratorNode (NULL, $3, NULL); 
         #if JSON==1
         if (interpreter::get()->json){
            runNode*a[1] = {$3} ;
            string b[1] = {"params"};

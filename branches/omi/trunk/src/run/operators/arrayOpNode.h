...
class implodeNode : public stringNode {
 public:
   ...
   void run ();
   /**
   * Devuelve un nodo unión de elementos  de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
...
class arraylastNode : public nexpNode {
 public:
    ...
    * valor una referencia al último elemento de
    * un array, o a un nodo nulo si el array está vacío.
    */
   void run ();
   /**
   * Devuelve un nodo último elemento de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
   * \return Método last.
   */ 
   static runNode* asMethod ();
 ...
 * \brief Nodo función priemer elemento de array
 * 
...
class arrayfirstNode : public nexpNode {
 ...
 /**
   ...
   /**
    * Método que ejecuta el nodo. Toma como 
    * valor una referencia al primer elemento de
    * un array, o a un nodo nulo si el array está vacío.
    */
   void run ();
   /**
   * Devuelve un nodo primer elemento de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
   * \return Método first.
   */ 
   static runNode* asMethod ();
 ...
 * 
 * Se encarga de insertar un eleemtno en una posición dada de un array.
...
class arrayinsertNode : public nexpNode {
 public:
    ...
    * Constructor de la clase
    * \param array Nodo que representa el array
    * \param index Nodo que representa la posicion en la que se llevará a cabo la inserción
    ...
    * la posicón dada y toma como valor una referencia al array con el elemento 
    * insertado
    */
   void run ();
   /**
   * Devuelve un nodo insertar elemento en array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
...
class arraydeleteNode : public nexpNode {
 public:
   ...
   /**
    * Método que ejecuta el nodo. Elimina el elemento que
    * ocuapa la posición dada dentro del array. Toma como 
    * valor una referencia al array con el elemento eliminado.
    */
   void run ();
   /**
...
class arrayunshiftNode : public arrayinsertNode {
 public:
   /**
    * Constructor de la clase
    * \param array Nodo que prepresenta el array de elementos
    * \param element Nodo que representa el elemento a insertar
    */
   arrayunshiftNode (runNode* array, runNode* element);
   /**
   * Devuelve un nodo insertar al inicio de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
...
class arraypushNode : public arrayinsertNode {
 public:
   ...
   /**
    * Método que ejecuta el nodo. Inserta el elemento al 
    * final del array. Se toma como valor una referencia al array con el elemento
    * insertado,
    */
   void run();
   /**
   * Devuelve un nodo inserta al final del array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
   * \return Método push.
   */ 
   static runNode* asMethod ();
...
class arrayshiftNode : public arraydeleteNode {
 public:
   ...
   /**
    * Método que ejecuta el nodo. Toma como valor el primer elemento de un array 
    * y lo elimina del mismo. Si el array está vacío toma como valor 
    * un nodo nulo.
    */
   void run ();
   /**
   * Devuelve un nodo  elimina y devuelve el primer elemento de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
   * \return Método shift.
   */ 
   static runNode* asMethod ();
...
class arraypopNode : public arraydeleteNode {
 public:
  /**
   ...
   /**
    * Método que ejecuta el nodo. Toma como valor el último elemento de un array 
    * y lo elimina del mismo. Si el array está vacío toma como valor 
    * un nodo nulo.
    */
   void run ();
   /**
   * Devuelve un nodo  elimina y devuelve el último elemento de array como cuerpo de un nodo función,
   * siendo un nodo this el array de elementos.
   * \return Método pop.
   */ 
   static runNode* asMethod ();

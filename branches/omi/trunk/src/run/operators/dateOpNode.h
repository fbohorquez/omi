 ...
 * 
 * Este nodo genera una caneda que se corresponde a una fecha dada según un formato y una 
 * marca de tiempo. 
 *  
...
class dateNode : public stringNode {
 public:
    ...
    * \param timestamp Nodo que respresenta la marca de tiempo. 
 ...
 * 
 * HAce que la ejecución del programa se para un número determinado de segundos.
 *
 */class sleepNode : public runNode {
 public:
   ...
   sleepNode (runNode * s);
   /**
    * Método que ejecuta el nodo.  Para la ejecución del programa un número dado de
    * segundos. 
    */
   void run ();
 private:

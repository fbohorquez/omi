...
/**
 * \file strOpNode.h
 * \brief Nodos operadores sobre cadenas.
 * 
 * En este fichero se encuentran los nodos ejecutables correspondientes 
 * a los operadores sobre cadenas. Estos son modelados mediante clases
 *  de objetos. 
*/
//-------------------------------------------------------------------------------------------
...
class catNode :
 ...
 public:
    ...
    * mediante la operación concatención entre el valor textual de los dos 
    * nodos.
    * 
 ...
 * \brief Nodo función replazo de subcadena
 * 
 * Este nodo se encarga de remplazar una subcadena dentro de 
 * una cadena por otra dada. La subcadena se deterina mediante 
 * una psición inicial y una longitud 
 *
 */

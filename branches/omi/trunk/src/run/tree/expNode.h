 ...
 * generales. Una expresión es modelada mediante un nodo que puede tener
 * un valor, este puede ser de tipo conocido o no.
 */
//-------------------------------------------------------------------------------------------
 ...
 *
 * Los nodos expresión son la base de muchos otros nodos que representan datos, operadores...
...
class expNode :
 ...
 public:
   /**
    * Método que toma un nodo lo clone en función de su tipo
    * \param node Node a clonar
    * \return Nodo nuevo.
    */
 ...
 * definido.
 *
 * Toda expresión definida podrá realizar una conversión de su valor interno a los tipos
 * booleano, numérico y cadena
 * 
 ...
 * puede contener cualquier tipo de elemento (string, arrays, enteros...). 
 *
 ...
 * array. El operador asignación guarda una referencia al elemento recién asignado.
 *
...
class nexpNode : public expNode {
 public:
   ...
   /**
    * Obtiene la referecia de la expresión no definida
    * \return Referencia de la expresión
    */
   virtual refNode* getRef ();
   /**
    * Resuelve un nodo ejectuble. Si el nodo dado como parámetro 
  ...
  /**
    ...
    * presenta una referencia obtiene el valor de esta, repitiendo el proceso 
    * hasta que se obtiene un nodo de tipo definido.  El nodo dado como parámetro
    * será modificado por el valor obtenido. El nodo dado parámetro referencia
    ...
    * dado en la tabla de funciones y se devuelve la función correspondiente
    * si existe, NULL en caso contrario. El parámetro toma como valor la función.
    * El parámetro dado como referencia tomará el valor de la última referencia resuleta
    * \param node Nodo que será resulto como función
   ...
   /**
    * Devuelve una cadena que se corresponde con la representación
    * textual del nodo que es referenciado
...
class logicNode :
 ...
 public:
  ...
  /**
    ...
    * \param node Node a partir del cual se tomará el valor
    */
   virtual void setNodeValue (runNode* node);
   /**
    * Genera el nodo clase "logicClass" asociado a todo nodo lógico y la añade a la tabla de símbolos clases
    */
 ...
 *
 * Los nodos aritméticos tienen un valor numérico asociado. Para la representacción
...
class arithNode :
 ...
 public:
   ...
   bool boolvalue () const;
   /**
    * Convierte un nodo a su valor cadena
    * \return Valor cadena
    */
   string strvalue () const;
   /**
...
class stringNode :
 ...
 public:
   ...
   string print () const;
   /**
    * Método que devuelve un nodo de tipo cadena con el mismo
    * valor del nodo.
    * \return Nodo cadena.
    */
   runNode* nodeval () const;
   ...
   num numvalue () const;
   /**
    * Comprueba la cadena representa un número
  ...
  /**
   * Obtiene el nodo clase asociado a los nodos cadenas
   * \return Nodo clase
   */
   runNode * getClass ();
   /**
    * Genera la clase "stringClass" asociada a toda cadena 
    */
   static void generateClass ();
   /**
    * Establece el valor de la cadena interna
    * \param s Cadena que se establecerá como valor
    */
   void setStrValue (string s);
   /**
    * Establece el valor de la cadena interna a partir de un nodo ejecutable
    * \param s Nodo que representa la cadena que se establecerá como valor
    */
   void  setNodeValue (runNode* node);
   /**
    * Obtiene el valor booleando del nodo
...
/**
 * \class fexpNode
 * \brief Nodo expresioens funciones
 * 
 * Defiene nodos que representan expresiones formadas mediante

...
\end{lstlisting}
\captionof{lstlisting}{Instalación de dependencias} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Descarga de código fuente} 
\hfill\\
...
$PS1 cd omi_$VERSION
\end{lstlisting}
\captionof{lstlisting}{Descompresión y desempaquetado} 
\hfill\\
\pagebreak
...
$PS1 ./configure --help 
\end{lstlisting}
\captionof{lstlisting}{Listado de la opciones de configuración para la compilación} 
\hfill\\
...
$PS1 ./configure 
\end{lstlisting}
\captionof{lstlisting}{Proceso de compilación} 
\hfill\\
...
$PS1 make 
\end{lstlisting}
\captionof{lstlisting}{Compilación} 
\hfill\\
...
$PS1 make install
\end{lstlisting}
\captionof{lstlisting}{Instalación} 
\hfill\\
\pagebreak
...
$PS1 make check
\end{lstlisting}
\captionof{lstlisting}{Comprobación de la integridad de la instalación} 
\hfill\\
...
$PS1 make clean
\end{lstlisting}
\captionof{lstlisting}{Limpiar el entorno de compilación} 
\hfill\\
...
$PS1 make unistall
\end{lstlisting}
\captionof{lstlisting}{Desinstalar el software} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Descargar el paquete} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Instalar el paquete} 
\hfill\\
...
$PS1 dpkg -r omi
\end{lstlisting}
\captionof{lstlisting}{Desinstalar el paquete} 
\hfill\\
...
$PS1 omi
\end{lstlisting}
\captionof{lstlisting}{Ejecutar intérprete} 
\hfill\\
...
$PS1 man omi
\end{lstlisting}
\captionof{lstlisting}{Uso del comando} 
\hfill\\
...
\begin{lstlisting}
   ...
   << "Soy un programa OMI"
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencias} 
\hfill\\
...
\begin{lstlisting}
   ...
   y = 2; #y vale 2
\end{lstlisting}
 \captionof{lstlisting}{Ejemplo comentario línea} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   ...
   y = 2; 
\end{lstlisting}
\captionof{lstlisting}{Ejemplo comentario bloque} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo identificadores} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de booleano} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de datos numéricos} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de cadena de caracteres} 
\hfill\\
...
un valor. Estas serán separadas por el carácter ``,'' y delimitadas entre llaves ``{'' y ``}''. El primer elemento del array se corresponde con el índice numérico $0$. \\
 ...
 \begin{lstlisting}
   ...
   */
   b = {0,"str", { 0, 1 } }; 
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de arrays secuenciales} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   b = { 10: 0, 0: "str", "K": { 0, 1 } }; 
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de arrays asociativos} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo array como objeto} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de nulo} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo función} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   exp = `a*bb`; 
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de expresión regular} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de operador} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos combinación de operadores } 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores lógicos} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores lógicos en cortocircuito} 
...
\begin{lstlisting}
   ...
   foo = "5" !== 5; // foo vale verdadero
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores de comparación} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de conversión implícita} 
\hfill\\
...
\begin{lstlisting}
   ...
   foo = 4 ^ 2; // foo vale 16 
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores aritméticos} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores sobre cadena de caracteres} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores de concatenación} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operador de acceso} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de error de un operador de acceso} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores de asignación} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operación y asignación} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de incremento y decremento } 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplos de operadores de conversión explícita} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de operadores sobre array} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de errores sobre operadores de array} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de operadores de comprobación de tipos} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de operador ternario} 
\hfill\\
...
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo de operador ternario simplificado} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de operador  fusión de nulos} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de operador de entrada} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   >>["Example:"] foo;
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de operador de entrada con prompt} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de operadores de salida} 
\hfill\\
...
\begin{lstlisting}
   ...
   << "Hola " << "mundo"; // Escribe la cadena "Hola \mundo\n" en la salida est|{\color{gray75}{á}}|ndar
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de operadores de salida para concatenación} 
\hfill\\
...
\begin{lstlisting}
   label: << "Sentencia";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo de etiquetas} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo if...else...} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo if...} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo if ... elif...else...} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo switch} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo switch break} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo switch default} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo while} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo do...while} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo for...} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo for... conjunto} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo for... conjunto con clave} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo iteración ágil} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo iteración ágil con acceso} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo iteración ágil con acceso indexado} 
\hfill\\
...
\begin{lstlisting}
  ...
  << "Finalizando";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia break} 
\hfill\\
...
\begin{lstlisting}
  ...
  << "Finalizando";
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo sentencia break con índice} 
\hfill\\
...
\begin{lstlisting}
  ...
  << "Finalizando";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo  sentencia continue} 
\hfill\\
...
\begin{lstlisting}
  ...
  << "Finalizando";
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo sentencia continue con índice} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   ...
   goto label;
\end{lstlisting}
\captionof{lstlisting}{Ejemplo  sentencia goto} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia goto (II)} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia include} 
\hfill\\
...
\begin{lstlisting}
   ...
   */
   << "Contenido fichero 2";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia include (II)} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia exit} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia with} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia try...catch...} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia throw} 
\hfill\\
...
\begin{lstlisting}
   ...
   << "Tras 10 segundos";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia sleep} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia typeof} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sentencia datInfo} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo variables} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo referencias} 
\hfill\\
...
\begin{lstlisting}
   ...
   << foo[0][1];
\end{lstlisting}
\captionof{lstlisting}{Ejemplo referencias a elemento de array} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo referencia a elemento constante} 
\hfill\\
...
\begin{lstlisting}
   ...
   << a; // Imprime 21
\end{lstlisting}
\captionof{lstlisting}{Ejemplo referencias como parámetros} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo referencias devueltas como valor } 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo funciones} 
\hfill\\
...
\begin{lstlisting}
   ...
   func1 ("valor1", "valor2");
\end{lstlisting}
\captionof{lstlisting}{Ejemplo llamada a función} 
\hfill\\
...
\begin{lstlisting}
   ...
   << foo; // Imprime 40
\end{lstlisting}
\captionof{lstlisting}{Ejemplo llamada a función con parámetros} 
\hfill\\
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo valor devuelto por función} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   func(); // Imprime "FUNC 2"
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo redefinición de funciones} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << sum(1) * 4; // Imprime 20
\end{lstlisting} 
\captionof{lstlisting}{Ejemplo  funciones con valores por defecto} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << foo; // Imprime 20
\end{lstlisting}
\captionof{lstlisting}{Ejemplo funciones con parámetros por referencia} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo definición de función como parte de expresión} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo acceso a función} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo funciones anónimas} 
\hfill\\ 
...
\begin{lstlisting} 
   ...
   << sum (4,5); 
\end{lstlisting}
\captionof{lstlisting}{Ejemplo expresiones parametrizadas} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo función de orden superior que recibe una función} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo función de orden superior que devuelve una función} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << add2 (4); // Imprime 6
\end{lstlisting}
\captionof{lstlisting}{Ejemplo clausura de funciones } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo función de contexto} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo implementación de decorador} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo estructura decorador} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << add8(5); // Imprime 13
\end{lstlisting}
\captionof{lstlisting}{Ejemplo aplicación parcial} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo listas por comprensión} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo listas por compresión con filtro} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo listas por compresión con clave} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo listas por compresión generando array asociativo} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo listas por compresión con bloque de sentencias} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo clases de objeto } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo instanciación de objeto} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo acceso a atributos y métodos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo accesibilidad métodos y atributos públicos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo accesibilidad métodos y atributos privados} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo atributos y métodos estáticos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo herencia de clases} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo herencia uso de parent} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo herencia uso de this} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo herencia uso de static} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   foo->meth2(); // Imprime "M|{\color{gray75}{é}}|todo 2"
\end{lstlisting}
\captionof{lstlisting}{Ejemplo redefinición de clases} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << str; // Imprime "ABCDX"
\end{lstlisting}
\captionof{lstlisting}{Ejemplo clase base} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo extensión de clase base} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo duck typing} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo método mágico \_str} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo método mágico \_get'} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << foo; // Imprime "No existe"
\end{lstlisting}
\captionof{lstlisting}{Ejemplo método mágico \_call} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo variables de entorno} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo acceso a argumentos} 
\hfill\\ 

 \begin{lstlisting}{language=bash}
   omi args.omi "ARG1" "ARG2" # Imprime args.omi ARG1 y ARG2
\end{lstlisting}
\captionof{lstlisting}{Ejemplo paso de argumentos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo excepciones} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo reflexión} 
\hfill\\ 
...
\begin{lstlisting}
   ...
   << x; // Imprime 7
\end{lstlisting}
\captionof{lstlisting}{Ejemplo eval} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo introspección de tipos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo error léxico} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo error sintáctico} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo error semántico} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_explode } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_find } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_replace } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_replace\_sub } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_upper } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_lower } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_search } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo str\_match } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo expresión regular } 
\hfill\\ 
...
\begin{lstlisting}   
   ...
   << sprintf("%%%%%%"); // %%%%
\end{lstlisting}
\captionof{lstlisting}{Ejemplo sprintf } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_implode } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_first } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_last } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_insert } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_delete } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_push } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_pop } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_unshift } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_shift} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo array\_reduce } 
\hfill\\ 
...
\begin{lstlisting}   
   ...
   foo = exec ('ps -e');
\end{lstlisting}
\captionof{lstlisting}{Ejemplo exec } 
\hfill\\ 
...
\begin{lstlisting}   
    ...
    */
    if (pid = fork ()) 
      ...
      << "Soy el proceso Hijo";
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fork } 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo wait} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo getpid} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo getppid} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo signal} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo shandler} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo exit\_process} 
\hfill\\ 
...
\begin{lstlisting}  
   ...
   process ( ~(i) { $(i) << "P2:".$; }, 100 );  
\end{lstlisting}
\captionof{lstlisting}{Ejemplo process} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo file} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fclose} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fput} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fget} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fseek} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo ftell} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fread} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fwrite} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo fappend} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo date} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo time} 
\hfill\\ 
...
\begin{lstlisting}  
   ...
   << _('cadena traducida');
\end{lstlisting}
\captionof{lstlisting}{Ejemplo carga de módulos} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo cabecera de módulo} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo implementación de módulo} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo compilación de módulo} 
\hfill\\ 
...
\end{lstlisting}
\captionof{lstlisting}{Ejemplo carga de módulo} 
\hfill\\ 

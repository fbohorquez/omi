...
\usepackage{listings}\lstdefinelanguage[]{omi} { 
   %
frame=Ltb,
     framerule=0pt,
     aboveskip=0.2cm,
...
numbers=left,
     ...
     breaklines=true,
     emph={%
$PS1, $PS2, ~, switch, case, default, goto, as, in, function, for, while, false, true, size, class, \<\<, private, return, &, include, global,~,new, null, if, else, this, $, prompt$, elif, break, continue %
},

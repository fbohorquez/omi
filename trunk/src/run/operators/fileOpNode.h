 ...
 * \brief Nodo fichero .
 * 
 * Este nodo abre un descriptor de fichero según una ruta dada y un modo.   
 * 
 * El modo puede ser:
 *    - r: Solo lectura.
 ...
 * 
 * Este nodo se encarga de escribir una cadena en la posición en la que ç
 * se encuentra un descriptor de fichero .
 */   
class fputNode : public arithNode {
 public:
    ...
    * que se encuentra el descriptor de fichero la cadena dada. 
    * 
...
class freadNode : public stringNode {
 public:
    ...
    * como valor la cadena resultante. Si el fichero no existe se produce un error.
    */     
   void run ();
 private:
   runNode *file_;
...
class fwriteNode : public stringNode {
 public:
   ...
   /**
    * Método  de ejecución. Escribe la cadena de caracteres como 
    * contenido del fichero. Si el fichero no existe es creado. Toma como 
    * valor la cadena escrita.
    */     
   void run ();
 private:
   runNode *file_, *str_;
...
class fappendNode : public stringNode {
 public:
   ...
   fappendNode (runNode * file, runNode* str);
    /**
    * Método  de ejecución. Añade la cadena al final de un fichero.  Si el 
    * fichero no existe es creado. Como valor toma la cadena escrita.
    */    
   void run ();
 private:
   runNode *file_, *str_;
 ...
 * 
 * Este nodo se encarga de obtener la posición del puntero de un 

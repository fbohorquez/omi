...
class lthNode :
 ...
 public:
   ...
   void run ();
   /**
    * Ejecuta la operación menor que sobre dos nodos dados.
    * \param op1 Primer nodo operando.
    * \param op2 Segundo nodo operando.
    * \return Valor de la operación.
    */
...
/**
 * \class idenNode
 * \brief Nodo operador idéntico.
 *
 * Este nodo implementa la operación idéntico entre dos nodos asociados.
 *
 * Esta operación, complementaria de la igualdad, compara además del valor
 ...
 * valor simbólico de los operandos. Así "2" != 2 es falso.
 *
 * El resultado de evaluar la expresión es un valor booleano.
 */
class neqNode :
...
/**
 * \class nidenNode
 * \brief Nodo operador no idéntico.
 *
 ...
 * simbólico de los operandos como su tipo.
 *
 * El resultado de evaluar la expresión es un valor booleano.
 */
class nidenNode :
 ...
 public:
    ...
    * Método que ejecuta el nodo. Procede a la ejecución de los nodos
    * asociados. Luego obtiene el valor lógico del nodo mediante la 
    * operación de comparación no idéntico entre el valor numérico 
    * de los dos nodos.
    */
   void run ();
   /**
 ...
 *
 * Este nodo implementa la operación de comprobación de tipo para el 
 * caso nulo.
 *
 ...
 *
 * Este nodo implementa la operación de comprobación del tipo para el 
 * caso booleano.
 *
 * Para determinar el valor de la operación se comprueba si el valor del 
 * operando es de tipo nulo.
...
class isBoolNode : public logicNode {
 public:
   ...
   void run ();
     /**
    * Método que ejecuta el nodo. Procede a la ejecución del nodo asociado. 
    * Comprueba si el tipo del nodo asociado es booleano para tomar el 
 ...
 *
 * Este nodo determina si un elemento es vacío. Trabaja sobre diversos 
 * tipos de datos.
 *
 * Si el elemento es booleano toma el valor de la negación, si es numérico
 * toma true si el elemento es 0 y false en caso contrario. Para una cadena 
 * de texto toma true si la cadena es vacía, false en otro caso.
 * Si se trata de una array toma el valor verdadero si este está vacío.
 */
class emptyNode : public logicNode {
 public:
   ...
   */   
   ...
   /**
   * Método que ejecuta el nodo. Procede a la ejecución del nodo asociado. 
   * y toma como valor un booleano que indica si este representa un 
   * elemento vacío.
   */       
   void run ();
 private:

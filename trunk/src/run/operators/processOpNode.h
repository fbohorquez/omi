...
/**
 * \class execNode
 * \brief Nodo operador ejecución de comando.
 * 
...
class execNode : public stringNode {
 public:
   ...
   /**
    * Método  de ejecución. Procede a la ejecución  del nodo que hace de 
...
/**
 * \class evalNode
 * \brief Nodo operador evaluación.
 * 
 * Este nodo procesa y evalúa una cadena como si de código fuente se 
...
class evalNode : public nexpNode {
 public:
   ...
   /**
    * Método  de ejecución. Procede a la ejecución  del nodo asociado 
    * que representa una cadena de código fuente. Toma como valor el 
    * resultado devuelto por la primera sentencia return evaluada, si no se 
    * ejecuta  una sentencia return al procesar la cadena se tomará como 
    * valor el nodo nulo. 
    */      
   void run ();
 private:
...
class forkNode: public arithNode {
 public:
   ...
   forkNode ();
   /**
    * Método  de ejecución. Crea una bifurcación en el proceso actual. 
    * Cuando este nodo es ejecutado se crea un proceso (hijo) copia del 
    * proceso actual (padre). 
    * En el proceso hijo el nodo tomará como valor aritmético 0, mientras
    * que en el proceso padre tomará como valor el identificador de proceso
    * del hijo. 
    */    
...
class waitNode: public arithNode {
 public:
   /**
    * Constructor de la clase.
    * \param  pID Identificador de proceso al que se debe esperar. Si es 
    * NULL se esperan todos los procesos hijos.
    */  
   waitNode (runNode * pID = NULL);
   /**
    * Método  de ejecución. Para la ejecución del proceso hasta que 
...
class getpidNode: public arithNode {
 public:
  /**
   ...
   getpidNode ();
    /**
    * Método  de ejecución. Toma como valor el identificador 
...
class processNode : public logicNode {
 public:
   ...
   /**
    * Método  de ejecución. Crea un nuevo proceso y llama a la función
    * dada pasándole la lista de parámetros. Como valor se toma 
    * un valor booleano que indica si el proceso se llevó a cabo de forma 
    * correcta.
    */       
   void run();
 private:
...
class exitProcessNode : public logicNode {
 public:
   ...
   exitProcessNode ();
   /**
    * Método  de ejecución. Finaliza la ejecución del proceso actúa. 
 ...
 public:
  /**
   ...
   signalNode (runNode* pid, runNode* signal);
    /**
      * Método  de ejecución. Envía una señal a un proceso a partir de su 
      * identificador de proceso. Como valor se toma un valor booleano que 
      * indica si el proceso se llevó a cabo de forma correcta.
    */      
   void run();
 private:
 ...
 * 
 * Nodo que permite asociar una función como manejador de una 
 * determinada señal de proceso. La función no recibirá parámetros algunos.
 */
class signalhandlerNode : public logicNode {
 public:
   ...
   /**
    * Método  de ejecución.  Asocia la función como manejador de la
    * señal de proceso. Como valor se toma un valor booleano que indica 
    * si el proceso se llevó a cabo de forma correcta.
    */      
   void run();
   /**

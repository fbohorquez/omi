...
boolNode::boolNode (boolNode* data) {
   if (data) {
...
//----------------------------------------------------------------------
//boolConstNode
boolConstNode::boolConstNode (bool data) :boolNode (data){}

void boolConstNode:: rmRef() {}
//----------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------
//numCostNode
numConstNode::numConstNode (num data) : numNode (data) {}

void numConstNode::rmRef() {}

//-------------------------------------------------------------------------------------------

//-------------------------------------------------------------------------------------------
//listNode
listNode::listNode (runNode* ele1, runNode* ele2 ):ele1_ (ele1), ele2_(ele2), exec_(false) {}
...
listNode* listNode::quitAsig () {
 ...
 bool listNode::is_runlist () const {
   return true;
}
//----------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------
//strConstNode
strConstNode::strConstNode (string data) : strNode (data) {}

void strConstNode::rmRef() {}
//-------------------------------------------------------------------------------------------
...
void arrayNode::insert (runNode* key, runNode* val, bool str ) {
   if (str) {
...
void arrayNode::del (runNode* key, bool str, bool force_position ) {
   if (str) {
      key = new strNode (stringNode::to_str(key));
   }
...
runNode* arrayNode::get (runNode* key, bool str) {
   if (str) {
      key = new strNode (stringNode::to_str(key));
   }
   return
...
void arrayNode::clearRef () {
   array_.clearRef();
}

void arrayNode::setArray (symbols array) {
   array_ = array;
}

void arrayNode::push (runNode* node) {
   this->insert (new numNode (this->getCount()), node);
}

runNode * arrayNode::copyArray (arrayNode * a) {
   return arrayNode::copy(a,new arrayNode());
}

runNode * arrayNode::getClass () {
   return custom_class_?custom_class_:arrayNode::class_;
}

bool arrayNode::boolvalue () const {
   return size();
}

num arrayNode::numvalue () const {
   return 0;
}

string arrayNode::strvalue () const {
   return "";
}
...
void arrayConstNode::rmRef() {}
//-------------------------------------------------------------------------------------------

//-------------------------------------------------------------------------------------------
//objectNode
objectNode::objectNode (classNode * c ) : class_ (c) { }

objectNode::objectNode (symbols* s, classNode * c) : class_ (c) { array_ = *s;}

objectNode::objectNode (listNode* l, classNode * c ) : arrayNode (l), class_ (c) {}

objectNode::objectNode (arrayNode* a) : arrayNode (a), class_ (NULL) {
   if (objectNode* obj = dynamic_cast<objectNode*> (a)){
      class_ = obj->class_;
   }
}

objectNode::objectNode (objectNode* a) : arrayNode (a), class_(a->class_) {}

runNode * objectNode::getClass () {
   return class_;
}
...
//-------------------------------------------------------------------------------------------
//regexpNode
regexpNode::regexpNode (string str): str_(str) {
   strNode s_node (str);
   ex_ = regex(s_node.strvalue());
}

regexpNode::regexpNode (regexpNode* r) {
   str_ = r->str_;
   ex_ = r->ex_;
}

regex regexpNode::exvalue () const {
   return ex_ ;
}

void regexpNode::run () {}

string regexpNode::strvalue () const {
   return str_;
}

bool regexpNode::boolvalue () const {
   return str_ != "";
}

num regexpNode::numvalue () const {
   return str_.size();
}

string regexpNode::print () const { 
   return "";
}
//-------------------------------------------------------------------------------------------
